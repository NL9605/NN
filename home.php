    ...
    <div class="list">
        <div class="row-1">
            <div class="ceilingfan">
                <div class="img-container">
                    <a href="product-detail.php?product_id=1"> <!-- Thay đổi ID sản phẩm -->
            ...
            <div class="pedestialfan">
                <div class="img-container">
                    <a href="product-detail.php?product_id=2"> <!-- Thay đổi ID sản phẩm -->
            ...
            <div class="wallfan">
                <div class="img-container">
                    <a href="product-detail.php?product_id=3"> <!-- Thay đổi ID sản phẩm -->
        ...
        <div class="row-2">
            <div class="exhaustfan">
                <div class="img-container">
                    <a href="product-detail.php?product_id=4"> <!-- Thay đổi ID sản phẩm -->
            ...
            <div class="accessories">
                <div class="img-container">
                    <a href="product-detail.php?product_id=5"> <!-- Thay đổi ID sản phẩm -->
